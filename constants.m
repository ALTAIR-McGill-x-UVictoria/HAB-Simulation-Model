...
r_balloon = 3.1;            % Radius of the balloon for simulink (m)
...
motor_joint_damp = 0.01;    % Motor joint damping coefficient (N*m/(deg/s))
motor_rotor_damp = 0.01;    % Motor rotor damping (N*m/(rad/s))
...
k3 = 0.1;                   % Motor smoothness penalty coefficient
k4 = 0.1;                   % Efficiency reward coefficient
...
criticLearnRate = 1e-4;     % Learning rate for value function
expBufferLen = 1e6;         % Buffer size for experience replay
batchSize = 32;             % Batch size for training
discountFactor = 0.98;      % Discount factor (future rewards importance)
